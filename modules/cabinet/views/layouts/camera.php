            ...
            if (groupMode == 'categories') {
                ...
                if (jsonCameras.length > 0) {
                    ...
                    jsonCameras.forEach(function (camera, index, array) {
                        ...
                        html += '<li ' + activeClass + '>' + '<a href="' + yii.app.createUrl('cabinet/camera/', {id: camera.id}) + '">' + '<span class="camera-name">' + camera.name.trunc(20) + '</span>' + '<img src="' + camera.thumb + '" class="img-responsive">' + '</a>' + '</li>';
