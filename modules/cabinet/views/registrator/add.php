    ...
    <div class="col-md-5">
        <div class="form-group">
            <div class="col-sm-4">
                ...
                <i class="fa fa-question-circle control-label pull-right" data-toggle="tooltip" data-placement="bottom" title="Определите лимит объема для хранения снимков. Если объем будет исчерпан, камера не сможет принять снимки"></i>
            </div>
            <div class="col-sm-8">
                <div class="row">
                    <div class="col-md-3 p-t-5" id="volume"><?=Yii::$app->user->identity->getFreeSpace()?> Gb.</div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <i class="fa fa-question-circle control-label p-l-20" data-toggle="tooltip" data-placement="bottom" title="Аналиттика вычисляет резерв по частоте кадров за последние сутки относительно оставшегося объема памяти и среднего размера файлов"></i>
                </span>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-3">
                ...
                <i class="fa fa-question-circle control-label pull-right" data-toggle="tooltip" data-placement="bottom" title='"'></i>
            </div>
            <div class="col-sm-9">
    ...
    <div class="col-md-6 col-md-offset-1">
        ...
        <div class="form-group">
            <div class="col-sm-3">
                ...
                <i class="fa fa-question-circle control-label pull-right" data-toggle="tooltip" data-placement="bottom" title='Например, "Вид на бассейн", "Отдел Маркетинга"'></i>
            </div>
            <div class="col-sm-9">
        ...
        <div class="form-group">
            <div class="col-sm-3">
                ...
                <i class="fa fa-question-circle control-label pull-right" data-toggle="tooltip" data-placement="bottom" title='Вы можете добавить объект, в котором расположена камера, по ссылке "Объекты"'></i>
            </div>
            <div class="col-sm-9">
        ...
        <div class="form-group">
            <div class="col-sm-3">
                ...
                <i class="fa fa-question-circle control-label pull-right" data-toggle="tooltip" data-placement="bottom" title="Используйте для соединения регистратора с FTP сервером"></i>
            </div>
            <div class="col-md-9">
                <input type="text" disabled="disabled" id="Registrator_ftp_login" class="form-control text-center" value="<?=$newRegistrator->getNewFtpLogin()?>"/>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-3">
