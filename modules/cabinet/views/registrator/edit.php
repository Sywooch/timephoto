    ...
    <div class="col-md-6 col-md-offset-1">
        ...
        <div class="form-group">
            <div class="col-sm-3">
                ...
                <i class="fa fa-question-circle control-label pull-right" data-toggle="tooltip" data-placement="bottom" title="Используйте для соединения камеры с FTP сервером"></i>
            </div>
            <div class="col-md-9">
...
<script>
    ...
    $(document).on('click', '#remove-registrator', function(e){
        ...
        swal({
            ...
            function(isConfirm){
                if (isConfirm) {
                    window.location.href = yii.app.createUrl('cabinet/registrator/delete', {id: registratorId});
                }
            });
    });
