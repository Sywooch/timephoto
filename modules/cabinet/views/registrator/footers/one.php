...
<script>
    ...
    $(document).on('click', '#dateDoFilter', function(e){
        e.preventDefault();
        window.location.replace(yii.app.createUrl('cabinet/camera', {id: cameraId, view: 'one', type: type, date: calendarDates}, '&', 'get'));
    });
    ...
    $(document).on('click', '#delete-selected', function(e){
        ...
        $.post(
            yii.app.createUrl('cabinet/remove/batch-remove'),
            {
                Images: getSelectedThumbnailsString()
            }
