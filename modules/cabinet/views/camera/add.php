...
<div class="col-md-12 divide-bottom">
    ...
    <div class="col-md-5">
        <div class="form-group">
            ...
            <div class="col-sm-7">
                ...
                <div class="m-t-5 text-center " id="volume"><?= Yii::$app->user->identity->getFreeSpace() ?> Gb.</div>
            ...
            <div class="col-md-6 icon-upload">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <button type="button" class="btn btn-white" id="trigger-file"><i class="fa fa-folder-open"></i> Выбрать логотип</button>
    ...
    <div class="col-md-6 col-md-offset-1">
        ...
        <div class="form-group">
            ...
            <div class="col-md-9">
                <input type="text" disabled="disabled" id="Camera_ftp_login"  data-toggle="tooltip" data-placement="bottom" title="Используйте для соединения камеры с FTP сервером"
                       class="form-control text-center" value="<?= Yii::$app->user->identity->accountNumber . '_' . $newCamera->getNextCameraNumber() ?>"/>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-3">
...
<script>
    $(document).ready(function () {
        $('.memory-slider').slider({
            max: <?=Yii::$app->user->identity->getFreeSpace()?>, min: 0.1, step: 0.1, value: <?=Yii::$app->user->identity->getFreeSpace()?>, slide: function (event, ui) {
