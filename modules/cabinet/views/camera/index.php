          ...
          <ul class="dropdown-menu" aria-labelledby="change-view">
            <li>
              <div class="row view-menu">
                ...
                <button  class="btn btn-inverse btn-sm size-change" data-size="6" data-column="2">2</button>
                <button  class="btn btn-inverse btn-sm size-change" data-size="4" data-column="3">3</button>
                <button  class="btn btn-inverse btn-sm size-change active" data-size="3" data-column="4">4</button>
                <span>X</span>
                      ...
                      <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                          ...
                          <?php if (Yii::$app->user->identity->canEdit()): ?>
                            <li><a href="<?= $this->context->createUrl(['/cabinet/camera/manage']) ?>"><i
                          ...
                          <li>
                            ...
                            <li>
                              <a href="#" class="toggle-camera <?= $camera->enabled ? 'active' : '' ?>"
                                 camera-id="<?= $camera->id ?>">
                                                        <span
    ...
    <?php else: ?>
      ...
      <div class="row">
        <div class="no-camera-add">
          <div class="col-md-3">
            <a href="<?= $this->context->createUrl(['/cabinet/camera/add']); ?>">
              <div class="well">
                <div class="row">
...
<script>
  ...
  $(document).on('click', '.toggle-camera', function (e) {
    ...
    $.post(yii.app.createUrl('cabinet/ajax/toggle-camera'), {
