        ...
        <div class="col-md-4">
            ...
            <div class="panel ">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-xs-4">
                            <span><?= (isset($stats['disk_space']['free'])) ? floor($stats['disk_space']['free']) : 0 ?>
                                %</span>
                        </div>
                        <div class="col-xs-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8">
                            <table class="camera-traffic">
                                <tr>
                                    <td class="text-right">
                                        <?= (isset($stats['traff_by_camera']['day'])) ? $stats['traff_by_camera']['day'] : 0 ?>
                                        Гб
                                    </td>
                                    <td>по тревоге</td>
                                </tr>
                                <tr>
                                    <td class="text-right">
                                        <?= (isset($stats['traff_by_camera']['week'])) ? $stats['traff_by_camera']['week'] : 0 ?>
                                        Гб
                                    </td>
                                    <td>по движению</td>
                                </tr>
                                <tr>
                                    <td class="text-right">
                                        <?= (isset($stats['traff_by_camera']['month'])) ? $stats['traff_by_camera']['month'] : 0 ?>
                                        Гб
                                    </td>
                                    <td>по расписанию</td>
                                </tr>
    ...
    var handleMorrisDonusChart = function () {
        Morris.Donut({
            ...
            data: [
                {
                    label: 'Свободно',
                    value: <?= (isset($stats['disk_space']['free'])) ? $stats['disk_space']['free'] : 0 ?>},
                {
                    label: 'Занято',
                    value: <?= (isset($stats['disk_space']['load'])) ? $stats['disk_space']['load'] : 0 ?>}
            ],
