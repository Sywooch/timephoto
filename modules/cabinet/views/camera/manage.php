          ...
          <tr camera-id="<?= $camera->id; ?>">
            ...
            <td class="text-center text-middle size-column">
              <div class="progress progress-sm active">
                <div class="progress-bar progress-bar-<?= $camera->getOccupiedPercent() > 80 ? 'warning' : 'success' ?>"
            ...
            <td class="text-center text-middle">
              <a href="#" class="btn btn-danger delete-images"
                 data-toggle="tooltip" data-placement="bottom" title="Удаление каждой N-й фотографии за выбранную дату. Будьте внимательны, после удаления, востановить невозможно"
                >Удалить все</a>
            </td>
            <?php if (Yii::$app->user->identity->canCopy()): ?>
              <td class="text-center text-middle">
                <a href="" class="btn btn-primary download-images"
                   data-toggle="tooltip" data-placement="bottom" title="Копирование каждой N фотографии за выбранную дату на диск вашего устройства"
                  >Скопировать</a>
              </td>
            <?php endif; ?>
          </tr>
