...
class CameraController extends \app\modules\public_cabinet\components\CabinetController
{
    ...
    /**
     * Example: http://timephoto.loc:8082/public_cabinet/public?token=33c6ffb2843fdd44cf099fe5ca0323a8&view=one
     * @param null $token
     * @param string $view
     * @param null $imageId
     * @param string $type
        ...
        if (isset($_POST['Camera'])) {
            ...
            if ($newCamera->validate()) {
                ...
                if ($newCamera->save()) {
                    ...
                    return $this->redirect(['/public_cabinet/camera/']);
                }
            }
        }
    ...
    public function actionEdit($id)
    {
        ...
        if ($camera->user_id != Yii::$app->user->identity->userId && $id != 0) {
            $this->redirect('/public_cabinet/camera/');
        }
            ...
            if (isset($_POST['Camera'])) {
                ...
                if ($camera->validate()) {
                    ...
                    if ($camera->save()) {
                        ...
                        return $this->redirect(['/public_cabinet/camera/edit', 'id' => $id]);
                    }
    ...
    public function actionDelete($id)
    {
        ...
        return $this->redirect(['/public_cabinet/camera/index']);
    }
