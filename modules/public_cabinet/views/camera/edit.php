...
<script>
    ...
    $(document).on('click', '#remove-camera', function (e) {
        ...
        swal({
            ...
            if (isConfirm) {
                //window.location.href = yii.app.createUrl('public_cabinet/camera/delete', {id: cameraId});

                $.post(yii.app.createUrl('public_cabinet/camera/delete', {id: cameraId}), {}).done(function (response) {
                })
