                    ...
                    <tr class="additional-user-row additional-user-info"
                        ...
                        <td>
                            <a href="#" data-type="text" data-name="login" data-pk="<?= $additionalUser['id'] ?>"
                               data-url="<?= $this->context->createUrl('/public_cabinet/user/ajax-edit-additional-user') ?>">
...
<script id="additional-user-cameras-template" type="text/x-handlebars-template">
    ...
    <tr>
        ...
        <td class="{{permissions_class}}">
            <a href="#" data-url="<?= $this->context->createUrl('/public_cabinet/user/ajax-set-additional-user-permession') ?>"
    ...
    <tr>
        ...
        <td>
            <a href="#" data-name="password" class="password-edit editable editable-click" data-pk="{{id}}"
               data-pk="{{id}}" data-url="<?= $this->context->createUrl('/public_cabinet/user/ajax-edit-additional-user') ?>">
            </a>
        </td>
        <td>
...
<script>
    ...
    function addAditionalUser() {
        ...
        if (newUserName !== '') {
            $.post(yii.app.createUrl('public_cabinet/user/ajax-add-additional-user'), {
    ...
    function removeAdditionalUser(self) {
        ...
        $.post(yii.app.createUrl('public_cabinet/user/ajax-remove-additional-user'), {
            pk: additionalUserId
        }).done(function (response) {
    ...
    function infoAdditionalUser(self) {
        ...
        $.post(yii.app.createUrl('public_cabinet/user/ajax-get-additional-user-info'), {
            pk: additionalUserId
