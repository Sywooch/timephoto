...
<script>
    ...
    $(document).on('click', '#clearDate', function (e) {
        e.preventDefault();
        window.location.replace(yii.app.createUrl('public_cabinet/camera', {id: cameraId, view: 'thumbs', type: type}));
    });
    ...
    $(document).on('click', '#delete-selected', function (e) {
        ...
        $.post(
            yii.app.createUrl('public_cabinet/remove/batch-remove'),
            {
                Images: getSelectedThumbnailsString()
            }
    ...
    $(document).on('click', '#type-filter', function () {
        ...
        if (!$('#all-option').prop('checked')) {
            ...
            window.location.replace(yii.app.createUrl('public_cabinet/camera', {id: cameraId, view: 'thumbs'}));
    });
