                        ...
                        <div class="panel-body">
                            <div class="image">
                                <a href="<?= $this->context->createUrl(['/public_cabinet/camera', 'id' => $camera->id]) ?>">
                                    <img src="<?= $camera->getLastImage()->getThumbnailUrl(); ?>"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="big">
                                        ...
                                        <div class="col-md-3">
                                            <div class="row">
                                                <?= $camera->getTotalSize(); ?> Гб.
                                                (<?= $camera->getOccupiedPercent() ?>%)
                                            </div>
                                        </div>
                                    </div>
                                    <div class="small">
...
<script>
    $(document).on('click', '.toggle-camera', function (e) {
        ...
        $.post(
            yii.app.createUrl('public_cabinet/ajax/toggle-camera'),
            {
    ...
    $(document).on('click', '.registrator-settings', function () {
        ...
        location.href = "/public_cabinet/registrator/edit/" + id;
    });
