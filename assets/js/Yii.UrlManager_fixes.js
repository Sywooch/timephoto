...
var UrlManager = (function () {
    ...
    urlManager.prototype.processRules = function () {
        if (Object.size(this.opts.rules) === 0 || this.enablePrettyUrl == false) {
            return;
        }
    ...
    urlManager.prototype.createUrl = function (route, params) {
        params = params || [];
        ...
        for (var i in this._rules) {
            ...
            var url = rule.createUrl(this, route, params);
        ...
        return this.createUrlDefault(route, params) + anchor;
    };

    urlManager.prototype.createUrlDefault = function (route, params) {
        if (this.opts.enablePrettyUrl) {
            ...
            var query = this.createPathInfo(params, '=', '&');
...
var UrlRule = (function () {
    ...
    var urlRule = function (route, pattern) {
        ...
        if (this.references !== {}) {
            ...
            var namedGroupPattern = /\(\?POST<(\w+)>.*?\)/g;
            ...
            this.routePattern = this.routePattern.replace(/\(\?POST<\w+>(.*?)\)/g, "($1)");
    ...
    urlRule.prototype.createUrl = function (manager, route) {
        var caseSensitive = '';
