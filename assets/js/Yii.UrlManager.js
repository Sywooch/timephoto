...
var UrlManager = (function () {
    ...
    urlManager.prototype.createUrl = function (route, params, ampersand, urlFormat) {
        params = params || [];
        ampersand = ampersand || '&';
        urlFormat = urlFormat || this.opts.urlFormat;
        ...
        return this.createUrlDefault(route, params, ampersand, urlFormat) + anchor;
    };

    urlManager.prototype.createUrlDefault = function (route, params, ampersand, urlFormat) {
        if (urlFormat === PATH_FORMAT) {
